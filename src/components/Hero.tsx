        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="glass rounded-2xl p-8 max-w-4xl mx-auto fade-in-up stagger-3 hover-lift">
            <p className="text-lg md:text-xl text-card-foreground leading-relaxed">
              ...
              <span className="font-semibold text-green-600 dark:text-cyan-400">Digital Commerce</span>,{' '}
              <span className="font-semibold text-blue-600 dark:text-emerald-400">IT & Marketing</span>,{' '}
