...
import logo from '../assets/99 logo gradient.png';
        ...
        <div className="flex justify-between items-center h-20">
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center transition-transform group-hover:scale-110 overflow-hidden">
                <img
                  src={logo}
                  alt="99 Logo"
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link to="/join" className="btn-modern text-sm hover-glow">
              Join Us
            </Link>
          </div>
